    ...
    <div className="home-container">
      <div className="jumbotron text-center">
        <div className="jumbotron-text-container">
          ...
          <Link to="/frontend/register" className="btn btn-secondary">Open Account</Link>
        </div>
      </div>
      <div className="features-container text-center">
        <div className="row">
          <div className="feature-item">
            <img src="/time.png" alt="Real-time Data" className="feature-icon" />
          ...
          <div className="feature-item">
            <img src="/risk.png" alt="Zero Risk" className="feature-icon" />
            <h5>Zero Risk</h5>
          ...
          <div className="feature-item">
            <img src="/file.png" alt="Unlimited Paper Trading Dollars" className="feature-icon" />
      ...
      <div className="copy-investors-section">
        ...
        <div className="investor-photo">
            <img src="/computer.png" alt="Top Investor" className="investor-image" />
        </div>
          <div className="copy-text">
            ...
            <Link to="/frontend/register" className="btn btn-secondary">Start Trading</Link>
          </div>
        </div>
      </div>
    </div>
